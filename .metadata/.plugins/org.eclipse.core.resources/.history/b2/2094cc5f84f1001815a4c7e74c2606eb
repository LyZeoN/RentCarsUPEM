...
public class BankServiceLocator extends org.apache.axis.client.Service implements fr.upem.bank.BankService {
    ...
    private java.lang.String Bank_address = "http://localhost:8080/WebBankService/services/Bank";
    ...
    public fr.upem.bank.Bank getBank() throws javax.xml.rpc.ServiceException {
    ...
    public fr.upem.bank.Bank getBank(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            fr.upem.bank.BankSoapBindingStub _stub = new fr.upem.bank.BankSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (fr.upem.bank.Bank.class.isAssignableFrom(serviceEndpointInterface)) {
                fr.upem.bank.BankSoapBindingStub _stub = new fr.upem.bank.BankSoapBindingStub(new java.net.URL(Bank_address), this);
                _stub.setPortName(getBankWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://bank.upem.fr", "BankService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://bank.upem.fr", "Bank"));
        }
