...
public class CarSquelleton{
	...
	public CarSquelleton(ObservationSquelleton[] observationsi,int idi,String model, double price, double pricelocation,int haveBeenRented, int globalMark) throws RemoteException {
		id = idi;
		this.model = model;
		this.price = price;
